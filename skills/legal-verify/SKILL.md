---
name: legal-verify
description: Pure verification pass over already-drafted legal material - checking every citation, quotation, fact, and procedural claim against a primary source without re-doing the substantive drafting. Use when a document already exists (written by the user, or by another Legal Chambers skill) and needs an integrity check before it is relied upon.
---
