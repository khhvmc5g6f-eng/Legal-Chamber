...
- Run `scripts/citation_lint.py`, `scripts/deadline_calculator.py --selftest`, `scripts/verify_matter_refs.py --selftest`, `scripts/verify_matter_persistence.py --selftest`, `scripts/legal_cli.py --selftest`, and `scripts/legal_api.py --selftest` before committing changes that touch citation, deadline, schema cross-reference, matter-persistence, CLI, or API logic.
