...
| Scotland | `STRUCTURAL_DRAFT` - court hierarchy, citation basics | **8 files (Contract, Delict, Property, Criminal, Family, Succession, Employment, Constitutional Law)** - added 23 August 2026, now expanding beyond its original four-entry start toward the same full 99-area coverage England & Wales already has; verified live against legislation.gov.uk and (where reachable) BAILII/Scottish Courts/the deciding tribunal's own site - see `jurisdictions/scotland/README.md` |
