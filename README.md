...
| Scotland | `STRUCTURAL_DRAFT` - court hierarchy, citation basics | **12 files (Contract, Delict, Property, Criminal, Family, Succession, Employment, Constitutional, Evidence, Human Rights, Landlord & Tenant, Insolvency Law)** - added 23 August 2026 across three batches, now well beyond its original four-entry start toward the same full 99-area coverage England & Wales already has; verified live against legislation.gov.uk and (where reachable) BAILII/Scottish Courts/the deciding tribunal's own site - see `jurisdictions/scotland/README.md` |
