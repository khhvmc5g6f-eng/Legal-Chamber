...
| Scotland | `STRUCTURAL_DRAFT` - court hierarchy, citation basics | **4 files (Contract, Delict, Property, Criminal Law)** - this repository's first Scottish Authority Graph content, added 23 August 2026, verified live against legislation.gov.uk and (where reachable) BAILII/Scottish Courts/the deciding tribunal's own site - see `jurisdictions/scotland/README.md` |
