...
- **A 99-area practice-area taxonomy** ([`docs/PRACTICE_AREAS.md`](docs/PRACTICE_AREAS.md)), with a **"Coverage status" table that is the authoritative, honest count** of how much of it actually has real content - currently **96 of 99 named areas** have a populated, primary-source-verified Authority Graph entry (92 in England & Wales, 2 in US-Federal, 1 in EU Law itself, and, newly, 1 in Evidence Law via Scotland's corroboration entry - previously mechanism-only case-management tooling for England & Wales, now genuine doctrine), all deliberately narrow (one or two doctrinal points each, not a survey of the field). **England & Wales's own coverage is now complete**: all 99 taxonomy areas have real content or an honestly-documented reason they don't (a case-management-only mechanism for Evidence Law, a genuine and thoroughly-searched absence of any case law for Space Law). Only 3 areas repo-wide have no mechanism yet - all in Rights-based, social, and emerging (Robotics & Autonomous Systems, Election/Disinformation Regulation, National Security Law) - the table says so plainly rather than letting a bare list of names imply broader coverage than exists. **Scotland's, Australia's, Canada's, New Zealand's, Spain's, France's, and the EU's Authority Graphs now exist for the first time**, four foundational entries each (Scotland: Contract, Delict, Property, Criminal Law - now expanded to sixteen with Family, Succession, Employment, Constitutional, Evidence, Human Rights, Landlord & Tenant, Insolvency, Agricultural, Mental Health, Criminal Procedure, and Company Law, the first jurisdiction beyond England & Wales to move past its original starting point toward full 99-area coverage; Australia: Contract, Tort, Property, Criminal Law; Canada: Contract, Tort, Criminal Law, plus a dedicated Quebec civil-law entry; New Zealand: Contract, Tort, Criminal Law, Treaty of Waitangi jurisprudence; Spain: Contract, Civil/Extracontractual Liability, Criminal, Employment Law - this repository's first civil-law jurisdiction with populated content; France: Civil/Extracontractual Liability, Criminal Law, Employment Law, Administrative Law/Judicial Review - sourced cleanly with no access blocks, a counterpoint to Spain's; EU: primacy of EU law, free movement of goods, competition law, and data protection - the primacy entry deliberately single-node since primacy has no standalone Treaty article) added to the same taxonomy rows - see the Jurisdictions table below. **All nine jurisdictions in this repository now have a populated Authority Graph.**
...
|---|---|---|
| England & Wales | `COMMUNITY_REVIEWED` - court hierarchy checked live against `judiciary.uk`, OSCOLA citation checked live against `law.ox.ac.uk/oscola`, both 23 August 2026 (see `jurisdictions/england-wales/README.md` frontmatter) | **98 files across all 99 practice-area subjects - complete.** Every named taxonomy area now has real content or an honestly-documented reason it doesn't, each verified live against Find Case Law and legislation.gov.uk |
...
| Scotland | `STRUCTURAL_DRAFT` - court hierarchy, citation basics | **16 files (Contract, Delict, Property, Criminal, Family, Succession, Employment, Constitutional, Evidence, Human Rights, Landlord & Tenant, Insolvency, Agricultural, Mental Health, Criminal Procedure, Company Law)** - added 23 August 2026 across four batches, now well beyond its original four-entry start toward the same full 99-area coverage England & Wales already has; verified live against legislation.gov.uk and (where reachable) BAILII/Scottish Courts/the deciding tribunal's own site - see `jurisdictions/scotland/README.md` |
| Australia | `STRUCTURAL_DRAFT` - court hierarchy, AGLC citation basics | **4 files (Contract, Tort, Property, Criminal Law)** - added 23 August 2026; AustLII/jade.io/the High Court's own routes blocked automated access far more consistently than other jurisdictions, so 3 of 4 case nodes rest on independent secondary-source corroboration, recorded honestly rather than upgraded - see `jurisdictions/australia/README.md` |
| Canada | `STRUCTURAL_DRAFT` - court hierarchy, McGill citation basics | **4 files (Contract, Tort, Criminal Law, plus a dedicated Quebec civil-law entry)** - added 23 August 2026; CanLII presented an interactive bot-verification CAPTCHA on every case fetch attempted (correctly declined rather than solved), so research used the Supreme Court of Canada's own site instead, though most case nodes still rest on secondary-source corroboration - see `jurisdictions/canada/README.md` |
| New Zealand | `STRUCTURAL_DRAFT` - court hierarchy, citation basics | **4 files (Contract, Tort, Criminal Law, Treaty of Waitangi jurisprudence)** - added 23 August 2026; legislation.govt.nz and courtsofnz.govt.nz both presented interactive bot-check gates (correctly declined rather than solved), so research used NZLII where reachable, though most case nodes still rest on secondary-source corroboration - see `jurisdictions/new-zealand/README.md` |
| Spain | `STRUCTURAL_DRAFT` - civil-law authority hierarchy, citation conventions | **4 files (Contract/Obligations, Civil/Extracontractual Liability, Criminal, Employment Law)** - added 23 August 2026, this repository's first civil-law jurisdiction with populated content; BOE and CENDOJ returned a genuine network-level block (connection refused / DNS failure, or a CAPTCHA), so most case nodes rest on secondary-source corroboration - see `jurisdictions/spain/README.md` |
| France | `STRUCTURAL_DRAFT` - civil-law authority hierarchy, citation conventions | **4 files (Civil/Extracontractual Liability, Criminal Law, Employment Law, Administrative Law/Judicial Review)** - added 23 August 2026, this repository's second civil-law jurisdiction with populated content; legifrance.gouv.fr fetched cleanly on every attempt across all four research passes, with no access block encountered at all - a direct counterpoint to Spain's genuine BOE/CENDOJ network-level blocks - so all four entries are `VERIFIED_PRIMARY_SOURCE` on every node |
| European Union (supranational) | `STRUCTURAL_DRAFT` - added after a stress test showed a country pack (e.g. France, Spain) cannot substitute for EU-level authority (GDPR and other Regulations are directly applicable) - CJEU hierarchy, citation basics | **4 files (primacy of EU law, free movement of goods, competition law, data protection)** - added 23 August 2026, this repository's ninth and final jurisdiction to move off zero; eur-lex.europa.eu fetched cleanly throughout, though its page-processing step repeatedly truncated the very long GDPR and *Schrems II* texts, worked around with direct official PDF extraction rather than a proxy; `curia.europa.eu`'s own case-law viewer returned only a JS-rendering shell on two of the four cases, worked around with a genuine in-session browser render and EUR-Lex's own case-law mirror - all four entries `VERIFIED_PRIMARY_SOURCE` on every node |
...
The other eight jurisdictions remain `STRUCTURAL_DRAFT` on the narrative axis simply because nobody has yet run the same live fetch-and-check pass against their own court-service/citation-authority websites that England & Wales just went through - it is real, bounded work (per `GOVERNANCE.md`: a primary source, a checked date, and a named reviewer, per claim changed), not a blocked or structurally impossible step. It happens jurisdiction by jurisdiction, same as the Authority Graph itself did. Scotland's, Australia's, Canada's, New Zealand's, Spain's, France's, and the EU's Authority Graph columns show this same jurisdiction-by-jurisdiction pattern already extending past England & Wales - the same live-verification discipline, four entries deep in each (Scotland now sixteen). Scotland's second through fourth batches continue the same widening-toward-full-coverage process England & Wales already completed; the same is intended for the other five jurisdictions and the EU at a later date. See [`docs/HONEST_STATUS.md`](docs/HONEST_STATUS.md) and [`docs/PRACTICE_AREAS.md`](docs/PRACTICE_AREAS.md)'s "Coverage status" table for the exact, area-by-area Authority Graph breakdown.
...
| Rights-based, social, and emerging (civil rights, disability, elder, housing, welfare, refugee, indigenous rights, climate, blockchain, biotech, robotics, election law, national security) | 10/13 |

England & Wales's coverage is now complete across all eleven categories - the last three areas in Rights-based, social, and emerging (Robotics & Autonomous Systems Law, Election/Disinformation Regulation, National Security Law) remain unbuilt and are named as such, not silently dropped. Every built entry is deliberately narrow: one or two doctrinal points backed by a real, checked case and statute, not a survey of the whole field - see any file in `jurisdictions/england-wales/authorities/` for what "built" actually means here.
