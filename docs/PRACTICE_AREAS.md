...
| Family Law | England & Wales - the sharing principle on divorce (`family-financial-remedies-sharing.json`). Scotland - cohabitants' capital-sum remedy on separation under the Family Law (Scotland) Act 2006 s.28, a genuinely distinct statutory scheme with no England & Wales equivalent (`jurisdictions/scotland/authorities/family-cohabitants-economic-advantage-disadvantage.json`, *Gow v Grant* [2012] UKSC 29). Needs, compensation, children, domestic abuse, adoption, surrogacy: not built |
| Succession Law | England & Wales - testamentary capacity, intestacy distribution (`succession-testamentary-capacity-and-intestacy.json`). Scotland - legal rights (forced heirship), a genuinely distinct feature with no England & Wales equivalent, and the moveable/heritable estate boundary they depend on (`jurisdictions/scotland/authorities/succession-legal-rights-moveable-estate-boundary.json`, *Macdonald v Macdonald's Executrix* [1932] UKHL 3). Will formalities, undue influence, probate procedure, family provision claims: not built |
...
| Criminal Procedure & Evidence | England & Wales - hearsay admissibility gateways, Article 6 compliance (`criminal-procedure-hearsay.json`). Scotland - the solemn/summary mode-of-trial classification and the 'master of the instance' doctrine underlying prosecutorial control of process, honestly scoped as adjacent rather than directly on point (`jurisdictions/scotland/authorities/criminal-procedure-prosecutor-master-of-instance.json`, *Arthur v HM Advocate* [2002] ScotHC 324) |
...
| Area | Coverage |
|---|---|
| Constitutional Law | England & Wales - prerogative power/parliamentary sovereignty (`public-law-parliamentary-sovereignty.json`). Scotland - the Scottish Parliament's legislative competence under the Scotland Act 1998 s.29 and its common-law reviewability (`jurisdictions/scotland/authorities/constitutional-legislative-competence-common-law-review.json`, *AXA General Insurance Ltd v Lord Advocate* [2011] UKSC 46) |
...
| Human Rights Law | England & Wales - s.6 HRA public-authority duty, the proportionality test (`human-rights-proportionality.json`). Scotland - the Scotland Act 1998 s.57(2) Convention-rights limit on the Scottish Government/Lord Advocate, a free-standing devolution-competence constraint distinct from the HRA itself (`jurisdictions/scotland/authorities/human-rights-lord-advocate-convention-rights-limit.json`, *Cadder v HM Advocate* [2010] UKSC 43) |
...
| Area | Coverage |
|---|---|
| Company / Corporate Law | England & Wales - the director's creditor duty and its s.172(3) trigger (`company-directors-creditor-duty.json`). Scotland - arrestment against company bank accounts and the genuinely distinctive individual/company statutory-protection asymmetry (`jurisdictions/scotland/authorities/company-arrestment-individual-company-asymmetry.json`, *Anwar v The Advocate General for Scotland* [2021] UKSC 44). Other general duties, wrongful/fraudulent trading, disqualification, shareholder remedies: not built |
...
| Competition / Antitrust Law | England & Wales - the Chapter II super-dominance pricing doctrine (`competition-super-dominance-pricing.json`, one node secondary-tier - see file). EU - TFEU art.102's abuse-of-dominance prohibition, qualified by the as-efficient-competitor test for loyalty rebates (`jurisdictions/eu/authorities/competition-abuse-of-dominance-intel-as-efficient-competitor.json`, *Intel v Commission*, C-413/14 P) |
| Insolvency & Restructuring Law | England & Wales - wrongful trading and its relationship to the creditor duty (`insolvency-wrongful-trading.json`). Scotland - the floating charge's purely statutory origin (no common-law/equitable root, unlike England) and its attachment/crystallisation limits (`jurisdictions/scotland/authorities/insolvency-floating-charge-statutory-origin-attachment.json`, *Sharp v Woolwich Building Society* [1997] UKHL 8) |
...
| Data Protection & Privacy Law | England & Wales - the material-damage requirement and representative-action bar, under the now-repealed DPA 1998 s.13 (`data-protection-compensation.json`, `Lloyd v Google LLC` [2021] UKSC 50). EU - GDPR arts.45-46's international-transfer mechanisms, construed in *Schrems II* to invalidate the EU-US Privacy Shield while leaving Standard Contractual Clauses valid subject to a case-by-case assessment (`jurisdictions/eu/authorities/data-protection-international-transfers-schrems-ii.json`, Case C-311/18). The EU jurisdiction pack's own structural narrative remains `STRUCTURAL_DRAFT` even though its Authority Graph is now populated - see the two-axis status system in the top-level README. Plus three real regulator profiles (`regulators/ico.md` UK, `regulators/cnil.md` France, `regulators/ftc.md` US) documenting each regulator's actual power/procedure. The modern UK GDPR/DPA 2018 Article 82/s.168 compensation provision itself: not independently verified |
...
| Area | Coverage |
|---|---|
| Landlord & Tenant Law | England & Wales - **historical/transitional only**: the pre-repeal Housing Act 1988 s.21 "no-fault" possession route and a gas-safety-timing point (`landlord-tenant-s21-historical.json`). S.21 was abolished by the Renters' Rights Act 2025 (effective 1 May 2026, confirmed live) - not current operative practice for new notices. The s.8 statutory-grounds route that replaced it: not built. Scotland - the Private Housing (Tenancies) (Scotland) Act 2016 s.51's exhaustive Schedule 3 eviction grounds, a structurally distinct scheme with no no-fault route at all (`jurisdictions/scotland/authorities/landlord-tenant-eviction-grounds-exhaustive.json`, *Wawrzonek v Galewski*, First-tier Tribunal for Scotland, FTS/HPC/EV/26/1444) |
...
| Agricultural Law | England & Wales - the automatic conversion of an agricultural tenancy at will into a full tenancy from year to year under AHA 1986 s.2 (`agricultural-tenancy-at-will-conversion.json`). Scotland - crofting, a genuinely unique form of land tenure with no England & Wales equivalent, and the statutory hardship/sound-management defences to a crofter's right to buy (`jurisdictions/scotland/authorities/agricultural-crofting-right-to-buy-hardship-defence.json`, *Malone v Pattinson*, Scottish Land Court SLC/39/17) |
...
| Mental Health Law | England & Wales - the Cheshire West "acid test" for deprivation of liberty and its MCA 2005 s.4A statutory trigger (`mental-health-deprivation-of-liberty.json`). Scotland - the Compulsory Treatment Order criteria under a genuinely distinct statutory scheme with its own tribunal (`jurisdictions/scotland/authorities/mental-health-compulsory-treatment-order-criteria.json`, Mental Health Tribunal for Scotland, MHTS/4/26/04/01073/S063) |
...
| Evidence Law | **Mechanism, not doctrine, for England & Wales**: `schemas/evidence.schema.json` and `skills/legal-evidence/SKILL.md` give a real Evidence Ledger for organising a matter's own evidence, but that is case-management tooling, not substantive evidence-law content (hearsay, privilege, admissibility rules) - not built. Scotland - genuine substantive doctrine: the corroboration requirement, a distinctive feature of Scots criminal procedure with no equivalent in England & Wales, restated by a 2023 full bench (`jurisdictions/scotland/authorities/evidence-corroboration-supports-confirms-strengthens.json`, *Lord Advocate's Reference No 1 of 2023* [2023] HCJAC 40, applying *Fox v HM Advocate* 1998 JC 94) - this is the taxonomy's first genuine case-law Authority Graph content for Evidence Law, not case-management tooling |
...
| EU Law (supranational) | `jurisdictions/eu/` - the EU's first Authority Graph content: the primacy of EU law over conflicting national law (`jurisdictions/eu/authorities/primacy-of-eu-law-costa-v-enel.json`, *Costa v ENEL*, Case 6/64, a deliberate single-node entry since primacy has no standalone Treaty article) and the free-movement-of-goods mutual-recognition principle (`jurisdictions/eu/authorities/free-movement-mutual-recognition-cassis-de-dijon.json`, TFEU art.34; *Cassis de Dijon*, Case 120/78). Two further EU entries (Competition, Data Protection) are cross-referenced under their own taxonomy rows above rather than duplicated here. The pack's own structural narrative (CJEU hierarchy, Treaty/Regulation/Directive precedence, ECLI citation) remains `STRUCTURAL_DRAFT` |
